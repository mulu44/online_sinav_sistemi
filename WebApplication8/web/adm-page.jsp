...
<body>
	<div class="top-area">
		<center><h2>ÖĞRETMEN PANELİNE HOŞGELDİNİZ</h2></center> <a href="controller.jsp?page=logout" class="button" style="float: right;background:crimson;color:white">çıkış</a>
	</div>
