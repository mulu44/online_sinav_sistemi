			...
			<div class="sidebar" style="background-image: url(sidebar-1.jpg)">
				<div class="sidebar-background" >
					...
					<div class="left-menu">
						...
						<a class="active" href="std-page.jsp?pgprt=1"><h2>DERSLER</h2></a>
						<a  href="std-page.jsp?pgprt=2"><h2>SONUCLAR</h2></a>
					</div>
				</div>
...
if(sec==0){
    ...
    time--;
               ...
               <form id="myform" action="controller.jsp">
                   ...
                   <input type="submit" class="add-btn" value="bitir">
               </form>
           ...
           <div class="title">Sınav Durumu</div>
           <div class="profile">
               <span class="tag">SINAV TARİHİ</span><span class="val"><%=result.getDate() %></span><br/>
               <span class="tag">BAŞLAMA</span><span class="val"><%=result.getStartTime() %></span><br/>
               <span class="tag">BİTİŞ</span><span class="val"><%=result.getEndTime() %></span><br/>
               <span class="tag">SINAV ADI</span><span class="val"><%=result.getcName() %></span><br/>
               <span class="tag">PUAN</span><span class="val"><%=result.getObtMarks() %></span><br/>
               <span class="tag">TOPLAM PUAN</span><span class="val"><%=result.gettMarks() %></span><br/>
               <span class="tag">DURUM</span><span class="val"><%=result.getStatus() %></span></h2>
           </div>
           <p></p>
           <p></p>
           <p></p>
        ...
        <div class="panel form-style-6" style="float: left;max-width: 900px; padding-top: 40px;">
            <div class="title" style="margin-top: -60px;">Dersin Sınavını Seçiniz</div>
       <br/>
        ...
        <option value="<%=list1.get(i)%>"><%=list1.get(i)%></option>
            ...
            <input type="submit" value="Sınava Başla" class="form-button">
            </form>
